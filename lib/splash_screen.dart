...
import 'package:quad/home_screen.dart'; // Import your home screen
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  void initState() {
    ...
    // Navigate to the home screen after a delay (e.g., 3 seconds)
    Future.delayed(Duration(seconds: 4), () {
      Navigator.pushReplacement(
        context, 
        MaterialPageRoute(builder: (context) => HomeScreen()), // Corrected syntax here
      );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: const Color.fromRGBO(255, 255, 255, 1),  // Background color of the splash screen
      body: Center(
        child: Image.network(
          // Using base64 image (decoded from the base64 string)
